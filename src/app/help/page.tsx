...
const faqData = {
  basic: [
    { 
      q: '什么是纪元智科？', 
      a: '纪元智科是一个GPU算力租赁平台，会员可以购买GPU算力，获得稳定收益。我们提供多种周期的算力，包括短期（3-7天）、中期（15天）和长期（30天）算力。' 
    },
    { 
      q: '什么是能量值？', 
      a: '能量值是平台内的虚拟积分，用于算力到期卖出时支付市场费。能量值可以通过服务商充值获得，也可以通过直推奖励获得。' 
    },
    { 
      q: '什么是积分？', 
      a: '积分是算力到期后获得的收益，可以转换为能量值使用。' 
    },
    { 
      q: '会员、服务商、分公司有什么区别？', 
      a: '会员：购买算力获得收益\n服务商：提供服务，获得技术服务费和能量值分成\n分公司：管理多个服务商，获得分公司收益分成\n总公司：平台运营管理' 
    },
  ],
  trade: [
    { 
    ...
    { 
      q: '算力到期后如何处理？', 
      a: '算力到期后可以卖出，卖出时需要用能量值支付市场费。市场费按算力收益比例收取，具体比例根据算力周期而定。' 
    },
    { 
      q: '购买算力后可以退款吗？', 
  ...
  profit: [
    ...
    { 
      q: '为什么收益要分成两部分？', 
      a: '为了保障平台运营和各方利益，收益分为：\n• 实际到手部分：直接进入您的账户余额\n• 能量值部分：需要用能量值支付，能量值会分配给服务商、分公司、直推人等' 
    },
  ],
  energy: [
    { 
    ...
    { 
      q: '能量值可以转让吗？', 
      a: '能量值只能在平台内使用，不支持转让给其他会员。' 
    },
    { 
      q: '能量值不足怎么办？', 
      a: '算力到期卖出需要能量值支付市场费。如果能量值不足，请及时联系您的服务商充值，否则无法完成卖出操作。' 
    },
  ],
  referral: [
    { 
    ...
    { 
      q: '直推奖励如何计算？', 
      a: '直推会员购买算力或支付能量值时，您可获得5%的奖励。奖励会自动计入您的能量值账户。' 
    },
    { 
      q: '如何查看我的直推会员？', 
